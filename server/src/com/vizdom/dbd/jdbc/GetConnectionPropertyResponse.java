...
/**
 * A connection property is returned as a sequence of values, where all
 ...
 */
class GetConnectionPropertyResponse extends BerSequence
{
    /* Connection properties currently have more or less the same 
     * implementation as statement properties. This may not be 
    ...
    static final BerIdentifier gIDENTIFIER = 
        ...
        BerDbdModule.gGET_CONNECTION_PROPERTY_RESPONSE);
     ...
     */
    GetConnectionPropertyResponse(Object[] aDataList, 
    ...
    {
        return "Connection property data being returned";
    }
}
