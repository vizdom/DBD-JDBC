...
class StatementFinishRequest extends BerInteger
{
    ...
    static final BerObjectFactory gFACTORY = new BerObjectFactory() {
        ...
        {
            return new StatementFinishRequest();
        }
    };
     ...
     */
    private StatementFinishRequest()
    {
        super();
    }

    /**
     * Returns the handle of the statement to be finished
     *
    ...
    {
        return "Statement finish request";
    }
}
