...
/**
 * A successful statement destroy response.
 *
 * @author Gennis Emerson
 * @version $Revision: 1.9 $
 */
class StatementDestroyResponse extends BerNull
{
    /** This object's identifier. */
    static final BerIdentifier gIDENTIFIER = 
        new BerIdentifier(BerTypes.APPLICATION, BerTypes.PRIMITIVE, 
        BerDbdModule.gSTATEMENT_DESTROY_RESPONSE);

    /**
     * A default constructor. 
     */
    StatementDestroyResponse()
    {
        super();
    }
