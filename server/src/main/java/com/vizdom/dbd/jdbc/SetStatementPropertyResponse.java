...
/**
 * The statement property was updated.
 *
 * @author Gennis Emerson
 * @version $Revision: 1.7 $
 */
class SetStatementPropertyResponse extends BerNull
{
    /** This object's identifier. */
    static final BerIdentifier gIDENTIFIER = 
        new BerIdentifier(BerTypes.APPLICATION, BerTypes.PRIMITIVE, 
        BerDbdModule.gSET_STATEMENT_PROPERTY_RESPONSE);

    /**
     * A default constructor. 
     */
    SetStatementPropertyResponse()
    {
        super();
    }
